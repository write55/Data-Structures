...
public class LinkedListProgram<E extends Comparable<E>> {
	...
	/**
	 * Adds a ListNode object in order, starting from the front of the list
	 * 
	 * @param input
	 *            ListNode object, added from front of list
	 */
	...
	/**
	 * Adds a ListNode object in order, starting from the back of the list
	 * 
	 * @param input
	 *            ListNode object, added from the back of the list
	 */
