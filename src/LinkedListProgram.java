...
public class LinkedListProgram<E extends Comparable<E>> {
    ...
    public static void main(String[] args) {
        ...
        asdf.add(new ListNode<>(1, null));
        asdf.add(new ListNode<>(2, null));
        asdf.add(new ListNode<>(3, null));
        asdf.add(new ListNode<>(4, null));
        asdf.add(new ListNode<>(5, null));
        asdf.add(new ListNode<>(6, null));
        asdf.add(new ListNode<>(7, null));
        asdf.add(new ListNode<>(8, null));
        asdf.add(new ListNode<>(9, null));
        asdf.add(new ListNode<>(10, null));
        System.out.println("Original List:");
        asdf.printList();
        asdf.reverseList(asdf.getFront());
