...
public class LinkedListRunner<E extends Comparable<E>> {
	...
	/**
	 * File reader method, reads file, converts to Person objects and adds to
	 * list
	 * 
	 * @param list
	 *            LinkedListProgram object to add new Person objects to
	 * @throws IOException
	 */
	...
	/**
	 * Uses String Tokenizer to convert file text to Person objects, adds to
	 * list
	 * 
	 * @param input
	 *            String, one line from the given file
	 * @param list
	 *            LinkedListProgram object to add new Person objects to
	 */
