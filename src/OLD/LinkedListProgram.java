...
public class LinkedListProgram<E extends Comparable<E>> {
    ...
    /**
     * front - first OLD.ListNode object in linked list
     */
    private ListNode<E> front;
    /**
     * back - last OLD.ListNode object
     */
    private ListNode<E> back;

    /**
     * Constructor for OLD.LinkedListProgram object
     */
    ...
    /**
     * Adds a given OLD.ListNode object to the linked list in order
     *
     * @param input OLD.ListNode object to be added in order
     */
    ...
    /**
     * Adds a OLD.ListNode object in order, starting from the front of the list
     *
     * @param input OLD.ListNode object, added from front of list
     */
    ...
    /**
     * Adds a OLD.ListNode object in order, starting from the back of the list
     *
     * @param input OLD.ListNode object, added from the back of the list
     */
    ...
    /**
     * Deletes a given OLD.ListNode object from the linked list, keeping the list in
     * order
     *
     * @param input OLD.ListNode object to be removed if present
     */
     ...
     *
     * @param reverseThis front OLD.ListNode of the linked list to be reversed
     * @return OLD.ListNode object, only used in the method for recursion
     */
    ...
    /**
     * Prints out the linked list backwards in a readable format
     */
